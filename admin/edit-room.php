...
<body>
    ...
    <?php
// Exchange rate (as of the current date, you might want to fetch it dynamically)
$exchange_rate = 74.50; // Example exchange rate (1 USD = 74.50 INR)

// Check if form is submitted
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["amount"])) {
    // Retrieve amount in dollars from form
    $amount_in_dollars = $_POST["amount"];

    // Convert dollars to rupees
    $amount_in_rupees = $amount_in_dollars * $exchange_rate;

    // Output the result with the Rupees symbol
    echo "Amount in Rupees: ₹" . number_format($amount_in_rupees, 2);
}
?>
